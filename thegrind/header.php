		...
		<h1>The Grind</h1>
            ...
            <div class="collapse navbar-collapse" id="navi">
                <ul class="navbar-nav mr-auto">
                    ...
                    <?php
//set navigation bar when logged in user role
                    if(isset($_SESSION['user_id'])){ echo'
                    <li class="nav-item">
                        <a class="nav-link" href="reservation.php" ><h3>New Reservation</h3></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="view_reservations.php" ><h3>View Reservations</h3></a>
                    </li>
                    <li class="nav-item">
...
//set navigation bar when logged in and role of admin
                    ...
                    echo'
                    <li class="nav-item">
                        <a class="nav-link" href="schedule.php" ><h3>Edit Schedule</h3></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="tables.php" ><h3>Edit Tables</h3></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="view_tables.php" ><h3>View Tables</h3></a>
                    </li>';    
                    }
                    }
//main page not logged in navigation bar
                    ...
                    <li class="nav-item">
	                 <a class="nav-link" href="#aboutus"><h2>About Us</h2></a>
	             </li>
	            <li class="nav-item">
	                <a class="nav-link" href="#gallery"><h2>Gallery</h2></a>
	            </li>
                    <li class="nav-item">
                        <a class="nav-link" href="#reservation"><h2>Reservation</h2></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="#footer"><h2>Find Us</h2></a>
                    </li>
                    '; } 
                    ?>
...
//log out button
                    ...
                    <button type="submit" name="logout-submit" class="btn btn-outline-dark"><h2>Logout</h2></button>
                    </form>';
                    }
                    else{  
                    echo '
			...
			<li><a class="nav-link fa fa-sign-in" data-toggle="modal" data-target="#myModal_reg">&nbsp;<b>Sing Up</b></a></li>
			<li><a class="nav-link fa fa-user-plus" data-toggle="modal" data-target="#myModal_login">&nbsp;<b>Login</b></a></li>
                    </ul> 
                    </div>
                    ';} 
                    ?>
...
//error handling of log in
            ...
            echo '<h3 class="text-danger text-center">Fill all fields, Please try again!</h3>';
            }
            else if($_GET['error1'] == "error") {   
            echo '<h3 class="text-danger text-center">Error Occured, Please try again!</h3>';
            }
            else if($_GET['error1'] == "wrongpwd") {   
                echo '<h3 class="text-danger text-center">Wrong Password, Please try again!</h3>';
            }
            else if($_GET['error1'] == "error2") {   
                echo '<h3 class="text-danger text-center">Error Occured, Please try again!</h3>';
            }
            else if($_GET['error1'] == "nouser") {   
                echo '<h3 class="text-danger text-center">Username or email not found, Please try again!</h3>';
                }
            }
            echo'<br>';
            ?>  
                    ...
                    <form action="includes/login.inc.php" method="post">
                        <h3 class="hint-text">If you have already an account please log in.</h3>
...
//script for modal to appear when success
                    ...
                    if($_GET['signup'] == "success"){ 
                        echo '<h2 class="bg-success text-center">Sign up was successfull! Please Log in!</h2>';
                    }
                }
                echo'<br>';
                ?>
    ...
    <!---sign up form -->
                    <div class="signup-form">
                        <form action="includes/signup.inc.php" method="post">
                            <h2 class="hint-text">Create your account. It's free and only takes a minute.</h2>
                            <div class="form-group">
                                    <input type="text" class="form-control" name="uid" placeholder="Username" required="required">
                                    <small class="form-text text-muted"><h3>Username must be 4-20 characters long</h3></small>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <input type="password" class="form-control" name="pwd" placeholder="Password" required="required">
                                <small class="form-text text-muted"><h3>Password must be 6-20 characters long</h3></small>
                            </div>
                            <div class="form-group">
                                <input type="password" class="form-control" name="pwd-repeat" placeholder="Confirm Password" required="required">
                            </div>        
                            <div class="form-group">
                            <small class="form-text text-muted"><h3>By signing up, you agree to our terms and policies.</h3></small>
                            </div>
                            <div class="form-group">
                                <button type="submit" name="signup-submit" class="btn btn-dark btn-lg btn-block">Register Now</button>
                            </div>
                        </form>
                            <div class="text-center"><h3>Already have an account? Ready to sign in</h3></a></div>
                    </div> 	
                </div>        
                <!-- Modal footer -->
                <div class="modal-footer">
